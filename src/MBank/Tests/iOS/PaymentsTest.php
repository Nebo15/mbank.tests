...
class PaymentsTest extends \MBank\Tests\MBankiOSTestCase
{
    ...
    public function testTransferInvalid()
    {
        ...
        $this->byXPath('//UIAApplication[1]/UIAWindow[2]/UIAScrollView[4]/UIATextField[5]')->click();
        $this->byXPath('//UIAApplication[1]/UIAWindow[3]/UIAPicker[1]')->byLinkText('May');
//        $this->byXPath('//UIAApplication[1]/UIAWindow[2]/UIAScrollView[4]/UIATextField[5]')->value('2015.01.01');
//TODO set data
