...
class Config
{
    private $config = [
        "ios" => [
            ...
            "Multibank" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[5]"],
            ...
            "Internet providers" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[4]"],
            "OnLime, Ростелеком" => ["type" => "name", "selector" => "OnLime, Ростелеком"],
            "АСВТ (Москва)" => ["type" => "name", "selector" => "АСВТ (Москва)"],
            "Yota Интернет" => ["type" => "name", "selector" => "Yota Интернет"],
            "Mamba" => ["type" => "name", "selector" => "Mamba"],
            "Цифра Один" => ["type" => "name", "selector" => "Цифра Один"],
            "WestCall (СПб)" => ["type" => "name", "selector" => "WestCall (СПб)"],
            ...
            "Telephony" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[7]"],
            "МГТС" => ["type" => "name", "selector" => "МГТС"],
            "Back from Provider Select" => ["type" => "name", "selector" => "Back from Provider Select"],
            "Security systems" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[9]"],
            "НТВ_Плюс" => ["type" => "name", "selector" => "НТВ Плюс"],
            "Wallet" => ["type" => "name", "selector" => "Wallet"],
            "Payment_systems" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[8]"],
            "Яндекс.Деньги" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[2]"],
            "Card2Card" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[2]"],
            ...
            "Games_networks" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[6]"],
        ...
        "web" => [
            ...
            "Payment_systems" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAWebView[1]/UIAStaticText[9]"],
            ...
            "Cable_networks" => ["type" => "xpath", "selector" => " //UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAWebView[1]/UIAStaticText[15]"],
            ...
            "Games_networks" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAWebView[1]/UIAStaticText[3]"],
