...
class Config
{
    private $config = [
        "ios" => [
            ...
            "Payment_systems" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[5]"],
            "Яндекс.Деньги" => ["type" => "name", "selector" => "Яндекс.Деньги"],
            "Card2Card" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[6]"],
            ...
            "Games_networks" => ["type" => "xpath", "selector" => "//UIAApplication[1]/UIAWindow[2]/UIATableView[1]/UIATableCell[3]"],
